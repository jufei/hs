...
class c_hs_helper(object):
    ...
    def click_position(self, x=pos_player_new_task_x, y=pos_player_new_task_y + 25,
                       speed=2, timer=3):
        pyautogui.moveTo(x, y, duration=speed, tween=pyautogui.easeInOutQuad)
        pyautogui.click()
        sleep(timer)
    ...
    def is_game_time(self):
        ...
        if new_day:
            ...
            self.day = day
            self.win_count = 0
        return clock >= 3 and clock < 20 and self.win_count < 30
